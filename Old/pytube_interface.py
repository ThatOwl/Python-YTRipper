...
class PyTubeDownloader:
    ...
    def _convert_to_m4a(self, audio_path: str, output_path: str, thumbnail_path: str = None) -> None:
        """
    ...
    def _download_single(self, download_dir: str, audio_only: bool = False, video_url: str = None, video_obj: ptf.YouTube = None) -> None:
        ...
        if audio_only:
            ...
            if audio_path:
                self._convert_to_m4a(audio_path, output_path, thumbnail_path)
        else:
    ...
    def _download_playlist(self, playlist_url: str, download_dir: str, audio_only: bool = False) -> None:
        ...
        #TODO return list of downloaded files and/or errors
